// Import the lodash library and the Print module
const _ = require("lodash");
const Print = require("../models/neo4j/print");

// Function to process a single Print record with details
